...
namespace HMS.DAL.Repository
{
    public class HotelRepository : IHotelRepository
    {
        ...
        {
            IEnumerable<Hotel> hotels = _dbContext.Hotels.OrderBy(h => h.Name).Include(r => r.Rooms).AsEnumerable().Where(h => Convert.ToBoolean(h.IsActive)).Select(_mapper.Map<Database.Hotel, Models.Hotel>);
